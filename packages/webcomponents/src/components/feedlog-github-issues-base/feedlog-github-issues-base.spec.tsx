...
describe('feedlog-github-issues-base', () => {
  const mockIssues = [
    {
      id: 1,
      title: 'Test Bug',
  ...
  it('renders', async () => {
    const page = await newSpecPage({
      components: [FeedlogGithubIssuesBase, FeedlogIssuesList, FeedlogCard, FeedlogBadge, FeedlogButton],
      html: `<feedlog-github-issues-base></feedlog-github-issues-base>`,
    });
  ...
  it('shows loading state', async () => {
    const page = await newSpecPage({
      components: [FeedlogGithubIssuesBase],
    });
    expect(page.root).toBeTruthy();
    if (page.root) {
