...
class FeedlogIssues {
    ...
    render() {
        ...
        return (hAsync(Host, { key: '731a882dc8d9672d0663797a0295863673a4da92', class: this.theme === 'dark' ? 'dark' : '' }, hAsync("div", { key: 'c9054d848e1ece24bd70433e5f270b472d25c913', class: "issues-container", style: containerStyle }, (this.heading || this.subtitle) && (hAsync("header", { key: 'a1828338ba2ad6830c0e11d1d227853efd4aebbe', class: "issues-header" }, hAsync("div", { key: '10cd6a97897b28d40bd19c6c5484d5d09c05e341', class: "header-content" }, this.heading && hAsync("h1", { key: '752543f307c31d7f3e27ec7d64edbd4ae2c211df', class: "issues-title" }, this.heading), this.subtitle && hAsync("p", { key: '5a71a768fa16bf2371746f32afb5cc41ef7897c2', class: "issues-subtitle" }, this.subtitle)))), this.loading && (hAsync("div", { key: 'fcbb88861ff71a940c2332ab4d977dfaedd28fef', class: "loading-state", role: "status", "aria-label": "Loading issues" }, this.renderSkeletonCards(3))), this.error && (hAsync("div", { key: '7a5de23137ccb1677498ba40c5881cc273077341', class: "error-state", role: "alert" }, hAsync("div", { key: '5636eaeef5374650c6d23b381d0ca08a46aa41b6', class: "error-state-content" }, this.renderErrorIcon(), hAsync("h2", { key: 'd1bfb25033d140c76fd00af2cadcb9ce33a41e93', class: "error-state-title" }, "Something went wrong"), hAsync("p", { key: 'cc0cd2771845340a81a86b52cf87f115fdfb1986', class: "error-state-message" }, this.error), hAsync("button", { key: '3a163bc809e0ae0fe6f16d4c4de1af9f6b21e776', type: "button", class: "error-retry-btn", onClick: () => this.feedlogRetry.emit() }, "Try again")))), !this.loading &&
            !this.error &&
