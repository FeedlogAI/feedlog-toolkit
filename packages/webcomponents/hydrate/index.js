...
class FeedlogIssues {
    ...
    render() {
        ...
        return (hAsync(Host, { key: '91d7236bba37d9ad44208d6aab7a917cc783ec57', class: this.theme === 'dark' ? 'dark' : '' }, hAsync("div", { key: '340acb62abd66504a69ebf50eaf7bdf4ea7f9762', class: "issues-container", style: containerStyle }, (this.heading || this.subtitle) && (hAsync("header", { key: 'dbd3d9da48bcb020e81231d0d64cb6b2a981fdab', class: "issues-header" }, hAsync("div", { key: '521f3a9ed3d603196202e8b9804f4f716c4543a8', class: "header-content" }, this.heading && hAsync("h1", { key: '59b17f5e8109dcc380d047963333d6993e1f6820', class: "issues-title" }, this.heading), this.subtitle && hAsync("p", { key: 'e043e2d7268a00281538ede227d7110f701efba4', class: "issues-subtitle" }, this.subtitle)))), this.loading && (hAsync("div", { key: '3236b349dffa9dd394e1e7ef668e1df02df32664', class: "loading-state", role: "status", "aria-label": "Loading issues" }, this.renderSkeletonCards(3))), this.error && (hAsync("div", { key: '046e2a281de9ebcb9da9c0d75fd5876308e4a702', class: "error-state", role: "alert" }, hAsync("div", { key: 'caa3f33326be01015fd67f646bae1e469c502923', class: "error-state-content" }, this.renderErrorIcon(), hAsync("h2", { key: '70b1b2ea0538a532e57b1afb7a61f1cec7f993e1', class: "error-state-title" }, "Something went wrong"), hAsync("p", { key: '058f9c5838d1e1535e539551747959fcf2349339', class: "error-state-message" }, this.error)))), !this.loading &&
            !this.error &&
