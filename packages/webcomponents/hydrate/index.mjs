...
class FeedlogIssues {
    ...
    render() {
        ...
        return (hAsync(Host, { key: '42604e2888af1e6ab4480cf8095071c62277c5ab', class: this.theme === 'dark' ? 'dark' : '' }, hAsync("div", { key: 'cd16f0918c22bda6c98ffb8bc06765a1d29b9d12', class: "issues-container", style: containerStyle }, (this.heading || this.subtitle) && (hAsync("header", { key: '33cf85d59351bb8f5c7dc52ea3bcf01043ef733b', class: "issues-header" }, hAsync("div", { key: 'a317427a91e9a2b5fb8c2046ad6bac703e1152e9', class: "header-content" }, this.heading && hAsync("h1", { key: '67f20bfe731289ff770009648861adb7e032b994', class: "issues-title" }, this.heading), this.subtitle && hAsync("p", { key: 'd6ca51b9477a5a84a5d8385499ec304fc26fe227', class: "issues-subtitle" }, this.subtitle)))), this.loading && (hAsync("div", { key: '59c107c8e60b3d002621560c841843382632209e', class: "loading-state", role: "status", "aria-label": "Loading issues" }, this.renderSkeletonCards(3))), this.error && (hAsync("div", { key: 'd9d5c3406af0d9042c567e4f917cc1e2331c3c9e', class: "error-state", role: "alert" }, hAsync("div", { key: '5770a2b06805d9cea99bfad6da4d363f70e7558c', class: "error-state-content" }, this.renderErrorIcon(), hAsync("h2", { key: '9e6b95363b7df907a820f988a40057c05f313734', class: "error-state-title" }, "Something went wrong"), hAsync("p", { key: '8f9b2d496e0e69db96fe2ff74db31890bd5ec115', class: "error-state-message" }, this.error), hAsync("button", { key: '7d1b5860e973f26782a2c66316a1f7a8a4cfd800', type: "button", class: "error-retry-btn", onClick: () => this.feedlogRetry.emit() }, "Try again")))), !this.loading &&
            !this.error &&
