...
export class FeedlogButton {
    ...
    render() {
        ...
        return (h("button", { key: 'e6544a690a61d957664c5b79f44b04ab18c3ed57', type: this.type, class: `button button-${this.variant} ${sizeClass}`, disabled: this.disabled, onClick: this.handleClick }, h("slot", { key: '0d451820486382d14180b6d2474c5968e934a573' })));
    }
...
//# sourceMappingURL=feedlog-button.js.map
