...
export const AllVariants = {
  render: () =>
    h(
      ...
      h('feedlog-badge', { variant: 'default' }, 'Default'),
      h('feedlog-badge', { variant: 'destructive' }, 'Destructive')
    ),
};
export const Labels = {
  render: () =>
    h(
      ...
      h('feedlog-badge', null, 'New'),
      h('feedlog-badge', null, 'Feature'),
      h('feedlog-badge', null, 'Enhancement'),
      h('feedlog-badge', { variant: 'destructive' }, 'Bug'),
      h('feedlog-badge', { variant: 'destructive' }, 'Critical')
    ),
};
